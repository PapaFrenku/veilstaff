...
const ModuleItem = styled.div`
  ...
  padding: 35px 20px;
  text-align: center;
  background: linear-gradient(to bottom, ${config.collors.primary} 50%, #fff 50%);
...
const modules = () => [
  ...
  },
  {
    ...
    content: "Для оценки профессиональных знаний сотрудников. Имеет хх настроек *",
  },
  {
    image: FeedBack,
    title: "Модуль обратной связи",
    content: "Позволяет получить достоверную анонимную информацию от сотрудников",
  },
  {
    image: Microphone,
